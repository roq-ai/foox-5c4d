  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox - your go-to job marketplace for freelancers, where companies meet talent and opportunities become reality."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox - your go-to job marketplace for freelancers, where companies meet talent and opportunities become reality.`}
            </Text>
            <Box
